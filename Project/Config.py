...
class DefaultConfig:
    #Twitter keys
    CONS_KEY = os.environ.get("ConsumerKey", "mtI3aZCC2TutQeg1aOdG4USgG")
    CONS_SECR = os.environ.get("ConsumerSecret", "bGMZTyzRarHHkFxViPNmwYq2fEp5DFnkdnuPnf1jSot7BctYH2")
